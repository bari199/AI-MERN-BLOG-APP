...
const CommentReplyInput = ({
  ...
  const generateReply = async () => {
    ...
    try {
      ...
      console.log(
        "Something went wrong while generating reply:",
        error
      );
    } finally {
      setLoading(false);
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex item-center justify-end gap-4">
            <button
              className="flex items-center gap-1.5 text-[14px] font-medium text-gray-500 bg-gray-100
              px-4 py-0.5 rounded-full hover:bg-gray-800 hover:text-white cursor-pointer"
              disabled={loading}
